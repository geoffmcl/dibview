...
#else	// !NEED_FAR_POINTERS - 80x86 case, define if we can

#ifdef USE_FMEM

#ifdef	WIN32
#define FMEMCOPY(dest,src,size)	memmove((void MLPTR )(dest), (const void MLPTR)(src), (size_t)(size))
#define FMEMZERO(target,size)	memset((void MLPTR )(target), 0, (size_t)(size))
#else	// !WIN32
...
#else
  register char MLPTR ptr = (char MLPTR ) target;
...
#endif		// !COMBWLIB - SInce these are in JUtils.c
//	from D:\DOWN\JPEGSRC - This is IJG Version 6a - June 1997
