 ...
 * wconf.h
 *
 * STANDARD WJPEG DLL CONFIGURATION
 *
...
/* We are NOT DOS MSDOS ... maybe still a DOS like ui ... */
...
// 15Apr97 - REMOVE TARGA and PPM SUPPORT - Never tried anyway!!!
...
#ifdef	ADD_BMP			/* See jinclude.h for this ... */
#include "wbmpsup.h"	/* Define BMP_SUPPORT in both 'C' and MASM ... */
#else
#undef BMP_SUPPORTED		/* MS/IBM Windows BMP/WMF support - grm Jan96*/
#endif
...
#ifndef _BASETSD_H_		/* WINDOWS is ok here - it uses an int */
typedef long INT32;
#endif	/* _BASETSD_H_ */
