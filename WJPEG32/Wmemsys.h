...
#define  _WMemsys_H
/*
 * wmemsys.h  (loosely based on jmemdos.h)
 *
...
// FIX16 - 6
#ifdef	_INC_WINDOWS
EXTERN void MLPTR jget_small PP((size_t sizeofobject));
EXTERN void jfree_small PP((void MLPTR object));
#else	// !_INC_WINDOWS
#ifndef	ALLFARMEM
...
EXTERN void MLPTR jget_large PP((size_t sizeofobject));
EXTERN void jfree_large PP((void MLPTR object));
#else
...
typedef struct backing_store_struct MLPTR backing_store_ptr;
