...
/* Emit a byte */
{
  struct jpeg_destination_mgr MLPTR dest = cinfo->dest;
...
{
  JQUANT_TBL MLPTR qtbl = cinfo->quant_tbl_ptrs[index];
  int prec;
  int i;
...
jinit_marker_writer (j_compress_ptr cinfo)
{
  ...
  cinfo->marker = (struct jpeg_marker_writer MLPTR )
